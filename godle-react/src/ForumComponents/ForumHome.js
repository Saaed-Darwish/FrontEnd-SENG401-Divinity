...
const Forum = (user) => {
  ...
  const getWidth = () => {
    if (window.innerWidth <= 700) return '90%';
    if (window.innerWidth <= 900) return '65%';
    return '57%';
  };

  return (
    <div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', maxWidth: '100vw' }}>
        ...
        {!addMode &&
          <div className="addThreadContainer" style={{ alignItems: "center", width: getWidth(), marginBottom: "30px" }}>
            <img style={{ maxHeight: "200px", maxWidth: "20vw", paddingRight: "5px" }} src={"./Images/" + deity.imagePath} alt="Description of the image" />
