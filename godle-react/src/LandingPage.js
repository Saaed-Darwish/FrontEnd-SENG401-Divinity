...
const LandingPage = ({ deity }) => {
    ...
    const getFontSize = () => {
        const width = window.innerWidth;
        if (width <= 700) return "small"; // mobile
    ...
    return (
        ...
        <><div style={{}}>
            <div style={{
                marginLeft: "10%", width: '60%', // Position the name absolutely
                // Place it at the vertical center
                left: "22%",
            }}> <a href="https://saaeddarwish.netlify.app/">Back to Portfolio</a>
                <div style={{
                    justifyContent: 'center', textAlign: 'left',
                    marginRight: '10%', marginTop: '5%', width: getWidth(), fontSize: getFontSize()
                }}>
