...
export function getDeitiesData() {
    return fetch('divinity-java-backend-production.up.railway.app/Admin/Deities')
        .then(response => {
            if (response.ok) {
...
export function getCalendarData(){
    return fetch('divinity-java-backend-production.up.railway.app/Admin/Calendar') 
        .then(response => {
            if (response.ok) {
...
export function getUsersData(){
    return fetch('divinity-java-backend-production.up.railway.app/Admin/Users') 
        .then(response => {
            if (response.ok) {
                return response.json(); // Return the JSON parsing promise
            } else {
...
export function getForumData(){
    return fetch('divinity-java-backend-production.up.railway.app/Admin/Forum') 
        .then(response => {
            if (response.ok) {
                return response.json(); // Return the JSON parsing promise
            } else {
