...
const AppNavbar = ({ user, setUser, setDeity, deity, setIsAdmin, isAdmin }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      let response = await fetch('http://divinity-java-backend-production.up.railway.app/Login', {
        method: 'POST',
        headers: {
      ...
      response = await fetch('http://divinity-java-backend-production.up.railway.app/IsUserMatched', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
